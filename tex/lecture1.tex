...
\end{lstlisting}}
	...
	\end{frame}
  	...
  	\begin{frame}{Mémoire statique vs Mémoire dynamique}
  	...
  	\begin{frame}{Caractéristiques  de la mémoire statique}
		\begin{itemize}
  	...
  	\begin{frame}{Caractéristiques de la mémoire dynamique}
  		\begin{itemize}
  	...
  	\subsection{Pointeur \& Arithmétique du pointeur}
