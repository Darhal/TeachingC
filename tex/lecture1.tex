...
\begin{lstlisting}[language=C,tabsize=2]
if (some_condition)
	statment; // Une seule instruction, càd un seul point-virgule	
[[else
...
for (initialisation; condition; increment) {
	// Une seule instruction, càd un seul point-virgule
}
...
\end{lstlisting}}
	...
	\begin{frame}{Les boucles}	
		...
		\end{block}
		\begin{alertblock}{Une boucle for peut être écrite comme une boucle while.e}
