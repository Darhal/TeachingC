...
\end{lstlisting}}
  	...
  	\begin{frame}{Les tableaux}
  		\framesubtitle{Représentation mémoire des tableaux en mémoire}
  		\begin{figure}[!h]
  			\centering
	...
	\begin{frame}{Les tableaux}
		\framesubtitle{Exemple: Représentation mémoire des tableaux en mémoire}
		\begin{block}{Exemple :}
			\texttt{tab} contient 8 éléments de type \texttt{int} indexables de $0$ à $7$ : 
			\arrayDeclExmpl
		\end{block}
...
// sizeof(triangle) = ??
// sizeof(triangle) / sizeof(union ieee754) = ??
\end{lstlisting}}
